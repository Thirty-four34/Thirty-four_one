...
public class DouDiZhu {
    public static void main(String[] args) {
       ...
       System.out.println("排序");
        Collections.sort(player1,new MyDoudizhu());
        System.out.println(player1);
        System.out.println("--------------------------------------------------");
        System.out.println(player2);
        System.out.println("排序");
        Collections.sort(player2,new MyDoudizhu());
        System.out.println(player2);
        System.out.println("--------------------------------------------------");

        System.out.println(player3);
        System.out.println("排序");
        Collections.sort(player3,new MyDoudizhu());
        System.out.println(player3);
        System.out.println("--------------------------------------------------");
...
class MyDoudizhu implements Comparator<String> {
